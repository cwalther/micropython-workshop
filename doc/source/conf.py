...
# -*- coding: utf-8 -*-
#
# MicroPython auf ESP8266 documentation build configuration file, created by
# sphinx-quickstart on Sun May  5 11:27:23 2019.
#
...
htmlhelp_basename = 'MicroPython-ESP8266'
...
latex_documents = [
    (master_doc, 'MicroPython-ESP8266.tex', 'MicroPython auf ESP8266 für Python-Anfänger',
     'Christian Walther', 'manual'),
]
...
man_pages = [
    (master_doc, 'micropython-esp8266', 'MicroPython auf ESP8266 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MicroPython-ESP8266', 'MicroPython auf ESP8266 Documentation',
     author, 'MicroPython-ESP8266', 'One line description of project.',
     'Miscellaneous'),
]
